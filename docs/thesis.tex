...
Konfiguracja QxOrm jest dość rozbudowana, a co za tym idzie skomplikowana. Rejestracja klas wymaga używanie wielu funkcji i makr w pliku nagłówkowym:
...
\lstinputlisting[style=customcmd,caption=Plik wyjściowy przykładowej aplikacji korzystającej z Qubica]{resources/sample_cmd.txt}

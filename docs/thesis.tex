...
{\color{purple}TODO: Interfejs i opis QxOrm, plus co najmniej jeszcze dwa.}
...
{\color{purple}TODO: Wykorzystane technologie, poprawiony opis, screeny, czy coś jeszcze?}
...
{\color{purple}TODO: Opis pozostałych elementów.}

\section{Konserwacja i inżynieria wtórna}

{\color{purple}TODO: Jak przebiega eksploatacja projektu? Jakie wady i zalety ujawniły się po okresie testowania i użytkowania? Jak można skorzystać z tej wiedzy praktycznej pod 
...
\lstinputlisting[style=customc,caption=Plik przedstawiający przykładowe zastosowanie Qubica]{resources/sample_app.cpp}
...
\lstinputlisting[style=customcmd,caption=Plik przedstawiajądsfadowe zastosowanie Qubica]{resources/sample_cmd.txt}

...
\begin{itemize}
\item Problem szczegółowości -- programiści mogą tworzyć nowe klasy z różnym poziomem szczegółowości. Mniej znacząca klasa, na przykład {\tt Adres}, może zostać
osadzona w klasie bardziej znaczącej, na przykład {\tt Użytkownik}. W bazie danych szczegółowość może zostać zaimplementowana jedynie na po\-ziomie tabeli
{\tt Użytkownik} oraz kolumny {\tt Adres}.

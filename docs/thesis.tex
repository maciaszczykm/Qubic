...
Rozdział \ref{technologie} zawiera opis technologii oraz metod wykorzystanych w części badawczej niniejszej pracy.
...
+ analiza istniejacych rozwiazan
+ technologie (sprzęt, oprogramowanie, serwer bazy danych, technologie i metodologie, język, biblioteki, wzorce)
+ 2x wymagania


\section{Projekt} % Diagramy klas, wzorce projektowe. Rodzaj aplikacji, wybór środowiska i platformy działania. Wybór bibliotek.
